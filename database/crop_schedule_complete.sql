-- Complete Crop Schedule Database Setup
...
-- Insert sample crop schedules (adjust user_id and crop_id based on your database)
...
CREATE INDEX IF NOT EXISTS idx_crop_schedules_user_id ON crop_schedules(user_id);
CREATE INDEX IF NOT EXISTS idx_crop_schedules_crop_id ON crop_schedules(crop_id);
CREATE INDEX IF NOT EXISTS idx_crop_schedules_status ON crop_schedules(status);
CREATE INDEX IF NOT EXISTS idx_crop_schedules_planting_date ON crop_schedules(planting_date);

CREATE INDEX IF NOT EXISTS idx_crop_feedback_user_id ON crop_feedback(user_id);
CREATE INDEX IF NOT EXISTS idx_crop_feedback_schedule_id ON crop_feedback(crop_schedule_id);
CREATE INDEX IF NOT EXISTS idx_crop_feedback_condition ON crop_feedback(crop_condition);
