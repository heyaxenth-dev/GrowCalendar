<?php
/**
 * Add Farmer Name Column to Crop Schedules Table
 * This script adds the farmer_name column to the crop_schedules table
 */

// Include database configuration
include 'config.php';

echo "<h2>Adding Farmer Name Column to Crop Schedules Table</h2>";
...
if ($column_exists) {
    echo "<p style='color: orange;'>⚠ The farmer_name column already exists in the crop_schedules table.</p>";
    echo "<p>No changes needed.</p>";
} else {
    // Read and execute the ALTER TABLE statement
    $sql_file = __DIR__ . '/alter_add_farmer_name.sql';
    ...
    if (file_exists($sql_file)) {
        ...
        if ($error_count > 0) {
            ...
            echo "<p>The farmer_name column has been added to the crop_schedules table.</p>";
        }
    } else {
...
echo "<hr>";
echo "<h3>Current crop_schedules Table Structure:</h3>";
$describe_query = "DESCRIBE crop_schedules";
