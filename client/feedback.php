        ...
        <div class="row mb-4">
            <div class="col-lg-12">
                <div class="alert alert-info">
                    ...
                    <p class="mb-0">Your feedback helps improve future crop recommendations. Please provide honest feedback about your crop performance, including any challenges you encountered. This information will help us enhance our recommendation system for all farmers.</p>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <span class="badge bg-primary"><?= count(array_filter($schedules, function($s) { return $s['feedback_status'] == 'ready_for_feedback'; })) ?> Ready for Feedback</span>
                        </div>
                        ...
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted">Complete your crop cycles and harvest to provide feedback on your crop performance.</p>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex gap-2">
                                            <?php if ($schedule['feedback_status'] == 'ready_for_feedback'): ?>
                                                <button class="btn btn-success btn-sm flex-fill" onclick="submitFeedback(<?= $schedule['id'] ?>, '<?= $schedule['crop_name'] ?>')">
                                            ...
                                            <button class="btn btn-outline-info btn-sm" onclick="viewScheduleDetails(<?= $schedule['id'] ?>)">
