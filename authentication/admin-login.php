...
<head>
    ...
    <title>Admin Login - GrowCalendar</title>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" action="./admin-login-code.php" method="POST"
                                        novalidate>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn-default w-100" name="login_admin" type="submit">
                                                Login
                                            </button>
                                        </div>
                                        <div class="col-12">
