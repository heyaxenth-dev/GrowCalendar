...
<head>
    ...
    <title>Admin Registration - GrowCalendar Bootstrap Template</title>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" action="./admin-register-code.php"
                                        ...
                                        <div class="col-md-12">
                                            <button class="btn btn-default w-100" type="submit"
                                                name="create_admin_acc">Create Account</button>
                                        </div>
                                        <div class="col-md-12">
                                            <p class="small mb-0">Already have an account? <a href="admin-login.php">Log
                                                    in</a></p>
                                        </div>
                                    </form>
